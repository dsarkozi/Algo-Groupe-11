...
/**
 * Un "FormalExpressionTree" est un arbre permettant de memoriser et de
 * manipuler une expression analytique.
 * 
 ...
 * l'arbre associe. Cette chaine est supposee correspondre a une expression
 * analytique syntaxiquement correcte et completement parenthesee. Une gestion
 * d'exceptions doit etre prevue lorsque cette precondition n'est pas verifiee.
 * 
...
public interface FormalExpressionTree
{
	 ...
	 * 
	 * @pre this represente une expression analytique syntaxiquement correcte.
	 * @post Une reference a un nouvel arbre representant la derivee formelle de
	 *       this est renvoyee.
	 */
